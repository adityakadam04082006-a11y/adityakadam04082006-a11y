...
<h2 align="left">
  ...
  <br> I'm Aditya Kadam, — a curious learner and a full stack developer in progress.  
Currently studying BTech in Robotics & Automation and building skills step by step. 💻<br><br>
...
- 🌐 Exploring basic frontend and backend tools like HTML, CSS, JS, React, Node.js  
- 💡 Curious about how real-world websites are built  
- 🛠️ Still experimenting and building small projects for learning  
- 📚 BTech in Robotics & Automation | 
- 🧠 I like understanding both logic & emotion behind systems  
- 🤝 Looking forward to future collaborations and open-source contributions!
